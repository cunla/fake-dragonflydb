## fake-dragonflydb: A python implementation of redis server

fake-dragonflydb is a pure-Python implementation of the DragonFly database.
...
```bash
pip install fake-dragonflydb        ## No additional modules support

pip install fake-dragonflydb[lua]   ## Support for LUA scripts

pip install fake-dragonflydb[json]  ## Support for RedisJSON commands

pip install fake-dragonflydb[probabilistic,json]  ## Support for RedisJSON and BloomFilter/CuckooFilter/CountMinSketch commands
```
